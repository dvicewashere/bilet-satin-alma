...
ini_set('session.cookie_secure', 0); // HTTPS için 1 yapın(SSL sertifikası olursa 1 yapılacak)
...
function getDB() {
    try {
        ...
        // Tabloların var olup olmadığını kontrol et, yoksa oluştur
        initDatabase($pdo);
...
function initDatabase($pdo) {
    try {
        // Kullanıcılar tablosunun var olup olmadığını kontrol et
        ...
        // Hata varsa, tabloları oluşturmayı dene
        createTables($pdo);
    }
}
...
function migrateCurrencyData($pdo) {
    try {
        ...
        // Hatayı kaydet ama uygulamayı durdurma
...
function createTables($pdo) {
    ...
    $sql_statements = [
        ...
        // Rezerve Edilmiş Koltuklar tablosu
